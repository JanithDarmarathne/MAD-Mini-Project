                ...
                try{
                    if(pwsCheck){
                        if(imagetoStore != null){
                            ...
                            db.close();
                            if(i != 0){
                                Toast.makeText(MainActivity.this,"Successfully created your account!",Toast.LENGTH_SHORT).show();
                                editName.setText("");
                                editEmail.setText("");
                                editAddress.setText("");
                            ...
                            Toast.makeText(MainActivity.this,"Please select the profile picture",Toast.LENGTH_SHORT).show();
                        }

                    }else{
                        Toast.makeText(MainActivity.this,"Your password not matched with confirm password",Toast.LENGTH_SHORT).show();
                    }
